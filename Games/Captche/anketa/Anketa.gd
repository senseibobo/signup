...
onready var question_scene = load("res://Games/Captche/anketa/Pitanje.tscn")
...
const pitanja = [
  ...
  {
	"pitanje": "What is a microphone?",
	"odgovori": ["Yes", "No"]
  },
  {
	"pitanje": "What gender are you?",
	"odgovori": ["Pan", "Shrek", "No"]
  },
  {
